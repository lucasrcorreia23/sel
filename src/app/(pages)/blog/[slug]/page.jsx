...
const PostsDetail = ({ params }) => {
  ...
  const postImageUrl = post.feature ? `${process.env.NEXT_PUBLIC_API_URL}${post.feature}` : '/path/to/default-image.jpg';
...
<div className="col-lg-6">
  <div className="row">
    <div className="col-lg-5">
      <h6 className="mil-upper mil-up mil-mb-30">Compartilhe em suas redes sociais</h6>
    </div>
    <div className="col-lg-7">
      <ul className="mil-list mil-dark mil-up mil-mb-30">
        ...
        <li className="mil-text-sm">
          <a href={`https://www.linkedin.com/shareArticle?mini=true&url=${currentUrl}&title=${encodeURIComponent(shareMessage)}`} target="_blank" rel="noopener noreferrer">
            LinkedIn
          </a>
        </li>
        <li className="mil-text-sm">
          <a href={`https://wa.me/?text=${encodeURIComponent(shareMessage + " " + window.location.href)}`} target="_blank" rel="noopener noreferrer">
            WhatsApp
          </a>
        </li>
      </ul>
