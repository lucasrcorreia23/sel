    ...
    <footer className="mil-relative">
        ...
        <div className="container mil-p-120-90">
            ...
            <div className="row align-items-start">
                ...
                <Link href="/img/pdfs/portfolio.pdf" target="_blank" className="mil-link mil-light mil-upper mil-right mil-mb-60">Baixar portfólio de produtos <span className="mil-arrow"><img src="/img/icons/5.svg" alt="arrow" /></span></Link>                         
